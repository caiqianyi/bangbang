...
public class DataDO implements Serializable {
	 ...
	 * 设置：治疗电流
	 */
	public void setTreatCurrent(Integer treatCurrent) {
		this.treatCurrent = treatCurrent;
	}
	/**
	 * 获取：治疗电流
	 */
	public Integer getTreatCurrent() {
		return treatCurrent;
	}
	/**
	 * 设置：治疗波形
